...
import com.example.sportzinteractiveapp.model.SecondMatchData
import com.example.sportzinteractiveapp.model.TeamOne
       ...
       // Log.e("TAG","team   "+team.Teams.size)
        ...
        holder.binding.team2.text= team.Teams.get(team.Matchdetail.Team_Home)?.Name_Full
         ...
         val intent =Intent(it.context, TeamActivity::class.java)
              intent.putExtra("TEAMDATA1", Gson().toJson(team.Teams.values) )
